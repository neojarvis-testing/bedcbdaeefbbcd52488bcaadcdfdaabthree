    ...
    public partial class ini : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ConferenceEventId = table.Column<int>(type: "int", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ConferenceEvents", x => x.ConferenceEventId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Bookings_ConferenceEvents_ConferenceEventId",
                        column: x => x.ConferenceEventId,
                        principalTable: "ConferenceEvents",
                        principalColumn: "ConferenceEventId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bookings_ConferenceEventId",
                table: "Bookings",
                column: "ConferenceEventId");
